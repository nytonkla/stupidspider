...
class Parser extends CI_Controller {
	...
	function parse_notebookspec_forum($fetch,$page)
	{
		$html = str_get_html($fetch);
		...
		else
		{
			...
			//echo "CommentCount:".count($comments);
			log_message('info',' parse_notebookspec_forum : found elements : '.count($comments));
			//echo "<hr>";
...
//				else { echo "file not null"; }
				...
				if ($page->domain_id == 4 || $page->domain_id == 25 || $page->domain_id == 26 || $page->domain_id == 27 || $page->domain_id == 20 || $page->domain_id == 28 || $page->domain_id >= 30)
				{
...
// 				}
				...
				if ($page->domain_id == 15 || $page->domain_id == 16 || $page->domain_id == 29)
				{
	...
	function test($id,$type=null)
	{
		...
		else
		{
			...
			if($page->domain_id == 25 || $page->domain_id == 26 || $page->domain_id == 27 || $page->domain_id == 4 || $page->domain_id == 20 || $page->domain_id == 28 || $page->domain_id >= 30)
			{

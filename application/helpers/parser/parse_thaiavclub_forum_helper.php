<?php
	function parse_thaiavclub_forum($fetch,$page,$debug=false)
	{
		$log_unit_name = 'parse_thaiavclub_forum';
		...
		else
		{
			...
			{
				$main_content = $html->find('h5[id^=subject] a');
				...
				$post_date = $pdate[4]."-".$mm."-".$pdate[3]." ".$pdate[5];

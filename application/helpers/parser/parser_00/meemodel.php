<?PHP
	...
	function parse_meemodel($fetch)
	{
		...
		{ 	
			...
			echo "<br>";
			echo "CommentDate:".$comment_date;//.$yy."-".$mm."-".$dd." ".$tt;
			echo "<br>";
			echo "<hr>";
		}
	...
	$url = "www.meemodel.com/webboard/16374.html";

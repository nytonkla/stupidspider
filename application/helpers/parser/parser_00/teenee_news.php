<?PHP
	...
	function parse_teenee_news($fetch,$debug = false)
	{
		...
		if($parsed_posts_count == 0)
		{
			...
			$s = $author->next_sibling()->next_sibling()->next_sibling()
	...
	$url = "http://tnews.teenee.com/politic/76378.html";

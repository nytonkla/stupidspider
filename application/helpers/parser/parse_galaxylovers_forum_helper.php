<?php
	function parse_galaxylovers_forum($fetch,$page,$debug=false)
	{
		$log_unit_name = 'parse_galaxylovers_forum';
		...
		else
		{
			if($parsed_posts_count == 0 && $page->sub_comment == 0) 
			{
				...
				$date_time = $html->find('.datePermalink .DateTime',0);
			...
			foreach($comments as $k=>$c)
			{
				...
				$c_date_time = $c->find('.datePermalink .DateTime',0);

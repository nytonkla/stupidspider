<?php
	function vol_comment_brand($month=null,$year=null,$client_id=null,$option=null)
	{
		$CI =& get_instance();
		
		$data = array();
		$report_name = 'vol_comment_brand';
		$report_title = 'Trend of Volume of Comments compared by Brands';
		...
		foreach($subjects as $s)
		{
			...
			$sql_talk = "SELECT subject_id, date(post.post_date) as date, count(*) as count
			FROM matchs,post 
